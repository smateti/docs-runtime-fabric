...
** If you are using CentOS v7.6, a full installation is required.
//If it's already installed, how does the user know if it's a 'full' install? Otherwise, they should be warned about package depnedencies, etc. Is this only for a manual installation?
